<script>
  ...
  for (let index = 0; index < $items.length; index++) {
    ...
    vat = total * 0.1;
    tax = total * $invoice.tax;
    amount = total + vat + tax;
  }
...
>
  <div>
    <div class="text-gray-400">Due on {$invoice.due_date}</div>
...
<div class="p-4">
  ...
  >
    ...
    <div class="flex justify-between py-2 ">
      ...
      <div class="text-xs font-bold">USD {vat}</div>
    </div>
    <div class="flex justify-between py-2">
      <div class="text-gray-400 text-xs">TAX</div>
      <div class="text-xs font-bold">USD {tax}</div>
    </div>
  ...
  <div class="flex items-center bg-white rounded-md p-4 cursor-pointer">
    <div>
      <svg
        width="20"
        height="20"
